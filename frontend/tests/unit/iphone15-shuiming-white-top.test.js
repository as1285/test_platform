...
describe('iPhone 15 收入纳税明细实底白顶栏', () => {
  ...
  it('筛选页首屏也打 15 标并铺白顶', () => {
    ...
    expect(shuiming).toContain('auth.js?v=20260918-ios27-fadepad');
