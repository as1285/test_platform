...
describe('OnePlus Ace Pro mine e1 pills', () => {
  ...
  it('first-paints zero bleed and width-based canvas on mine.html / auth-boot', () => {
    ...
    expect(mine).toContain(':not(.app-android-oneplus-acepro) body.page-mine .mine-e1-canvas');
    ...
    expect(mine).toMatch(/auth-boot\.js\?v=20260909-android-statusbar-rollback/);
    expect(mine).toMatch(/auth\.js\?v=20260909-android-statusbar-rollback" defer/);
  });
