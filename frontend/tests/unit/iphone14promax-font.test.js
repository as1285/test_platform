...
describe('iPhone 14 Pro Max 首页通知条 / 纳税明细字号', () => {
  ...
  it('首页 a1 通知条在 14 Pro Max 放大到 18px', () => {
    ...
    expect(shouye).toContain('auth.js?v=20260920-15pm-list-outer');
  });
  ...
  it('我的页 14 Pro Max 单独回退到 9/1 底图，隐藏 HTML 胶囊避免叠字', () => {
    ...
    expect(mine).toContain('auth.js?v=20260919-note13pro-mine');
  ...
  it('登录页 14 Pro Max 放大标题/输入并加宽表单', () => {
    ...
    expect(login).toContain('auth.js?v=20260920-15pm-list-outer');
  });
});
