...
describe('vivo S15 status-bar inset', () => {
  ...
  it('first-paints tax pages so 返回 is not under the system clock', () => {
    ...
    expect(pages.shuimingResult).toContain('auth.js?v=20260917-ios27-seam');
    expect(pages.shuiming).toContain('auth.js?v=20260917-ios27-seam');
    expect(pages.xiangqing).toContain('auth.js?v=20260917-ios27-seam');
    expect(pages.shouye).toContain('auth.js?v=20260916-iphone14pm-font');
    expect(pages.mine).toContain('auth.js?v=20260917-14pm-plain2');
