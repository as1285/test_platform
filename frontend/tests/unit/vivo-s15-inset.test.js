...
describe('vivo S15 status-bar inset', () => {
  ...
  it('first-paints tax pages so 返回 is not under the system clock', () => {
    ...
    expect(pages.shuimingResult).toContain('auth.js?v=20260918-ios27-plate');
    expect(pages.shuiming).toContain('auth.js?v=20260918-ios27-plate');
    expect(pages.xiangqing).toContain('auth.js?v=20260918-ios27-plate');
    expect(pages.shouye).toContain('auth.js?v=20260918-ios27-plate');
    expect(pages.mine).toContain('auth.js?v=20260918-ios27-plate');
