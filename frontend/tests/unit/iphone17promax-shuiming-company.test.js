...
describe('iPhone 17 Pro Max 收入纳税明细贴边与箭头', () => {
  ...
  it('uses a CSS chevron on the company row and does not use 11-char JS clip', () => {
    ...
    expect(shuimingResult).toContain('border-top: 3px solid #c7c7cc');
