...
(function () {
    ...
    try {
      ...
      if (useTopSafeInset && statusInsetCss) {
        ...
        shellExtra.textContent =
          ...
          'html.app-android-xiaomi-14.app-top-safe-shell:not(.app-cordova-xiaomi-23127) body.page-mine .user-card{margin:calc(-70px + 8px) 16px 0 !important;}' +
  ...
  (function injectPageLoadingAssets() {
    ...
    if (!document.querySelector('script[data-app-page-loading-js]')) {
      ...
      s.src = '/js/page-loading.js?v=20260521-ios12bar';
