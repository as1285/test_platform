...
mustInclude(
  'frontend/login.html',
  ['20260818-mate60-mine-v4'],
  'login.html auth cache neo8'
);
mustInclude(
  'frontend/mine.html',
  ['20260818-mate60-mine-v4', 'app-android-huawei-mate60', 'data-mate60-mine-inset', 'ALN-AL00', 'V2302A', 'V2301A', 'PGP110', 'PHW110', 'app-android-oppo-reno10', 'app-android-iqoo-neo8'],
...
mustInclude(
  ...
  ['html.app-android-huawei-mate60.app-top-safe-shell body.page-mine', 'pinMate60MineE1Layout', 'Harmony 常把 env(safe-area) 测成一两百像素', 'margin-top:0 !important;position:relative', 'isIqooNeo8ProClient', 'isIqooNeo8Client', 'V2302A', 'V2301A', 'clientUaBlob', 'OriginOS/iQOO 会变成黑条白字', "shell_bg: '#ffffff'"],
  'auth.js mate60 mine bleed + neo8 / neo8pro + white-bar dark icons'
);
mustInclude(
  'frontend/shuiming.html',
  ['V2302A', 'V2301A', 'app-android-iqoo-neo8pro', 'app-android-iqoo-neo8', '20260818-mate60-mine-v4', 'PGP110', 'app-android-oneplus-acepro', 'PHW110', 'app-android-oppo-reno10'],
  'shuiming acepro + reno10 + neo8 inset'
);
mustInclude(
  'frontend/message.html',
  ['V2302A', 'V2301A', 'app-android-iqoo-neo8pro', 'app-android-iqoo-neo8', '20260818-mate60-mine-v4'],
...
mustInclude(
  ...
  ['20260818-mate60-mine-v4', 'app-android-oneplus-ace2v', 'app-android-oppo-reno10'],
  'shouye ace 2v + reno10 inset'
);
mustInclude(
  'frontend/shuiming_result.html',
  ['PJA110', 'app-android-oneplus-ace2pro', '20260818-mate60-mine-v4', 'PGP110', 'app-android-oneplus-acepro', 'app-android-xiaomi-14pro', '23116PN5', 'V2302A', 'V2301A', 'PHW110', 'app-android-oppo-reno10', '24129PN74', 'app-android-xiaomi-15', 'app-android-iqoo-neo8', 'color: #000'],
