...
| 端 | 安装方式 |
|----|----------|
| **安卓 / Android 版** | 在安装页点击 **「下载 Android 安装包」**，下载完成后按提示安装。若系统提示「未知来源」，请在设置中允许本次安装。 |
| **苹果 iOS 版** | 在安装页点击 **「下载 iOS 描述文件」**，按页内 **苹果安装视频** 操作；安装后请到 **设置 → 通用 → VPN 与设备管理** 中信任描述文件。 |
...
**浏览器直接打开安装页（请将地址替换为客服提供的链接）：**

```
https://你的安装页域名/install_guide.html
```
